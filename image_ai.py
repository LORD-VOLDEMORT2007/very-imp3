...
def collector1(Collect_Button_pressed1):
    ...
    if (Collect_Button_pressed1 == "true"):
        ...
        while True:
            ...
            cv2.imwrite("training_images/class1/frame" + str(NumberOfFrames) + ".jpg" , frame)
...
def collector2 (Collect_Button_pressed2):
    ...
    if (Collect_Button_pressed2 == "true"):
        ...
        while True:
            ...
            cv2.imwrite("training_images/class2/frame" + str(NumberOfFrames) + ".jpg" , frame)
...
def train(Train_button_pressed):
    ...
    if Train_button_pressed == "true":
        ...
        training_image_directory = "training_images"
